...
/* BASE */
    ...
    /*$(window).load(function() {*/
        var directores_html_new = '';
        var directores_html = $('body.equipo-css section.b11 a[href="#popup-5"] .b11__text p').html();
        console.log(directores_html);
        var directores_array = directores_html.split(';');
        console.log(directores_array);
        for (i = 0; i < directores_array.length; i++) {
            directores_html_new += directores_array[i] + '<br />';
        }
        $('body.equipo-css section.b11 a[href="#popup-5"] .b11__text p').html(directores_html_new);
    /*});*/
