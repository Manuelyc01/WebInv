<div class="panel panel-white ui-sortable-handle" style="opacity: 1;">
    <div class="panel-heading">
        <h3 class="panel-title form-title"> Crear & Editar - Gestión nivel 3 - Contenido </h3>
    ...
    <div class="panel-body form-horizontal">
        ...
        <div class="form-group {{ $errors->has('gestion_nivel3_id') ? 'has-error' : '' }}" >
            {!! Form::stdSelect('Gestión nivel 3', 1, 'gestion_nivel3_id', $ddlGestionNivel3, null) !!}
        </div>
