<div class="panel panel-white ui-sortable-handle" style="opacity: 1;">
    ...
    <div class="panel-body form-horizontal">
        ...
        <label class="col-sm-2 control-label"><strong> Equipo / Colaborador</strong></label>
            <div class="col-sm-8">
                <input class="form-control" placeholder="" type="text" value="{{$equipoAsignado->des_equipo}}  ({{ @$equipoAsignado->cod_opatrimonial }} / {{ @$equipoAsignado->serie_equipo}})  /  {{$equipoAsignado->no_colaborador}}{{$equipoAsignado->ap_paterno_colaborador}}" disabled>
            </div>
        </div>
        @else
        @if(isset($x))
        ...
        <label class="col-sm-2 control-label"><strong> Equipo / Colaborador</strong></label>
            <div class="col-sm-8">
                <input class="form-control" placeholder="" type="text" value="{{@$element->des_equipo}} ({{ @$element->cod_opatrimonial }} / {{ @$element->serie_equipo}})  /  {{@$element->no_colaborador}}{{@$element->ap_paterno_colaborador}}" disabled>
            </div>
        </div>
        @endif
